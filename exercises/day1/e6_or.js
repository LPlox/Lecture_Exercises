...
console.log(testLogicalAnd(5)); //should return the string No
console.log(testLogicalAnd(6)); //should return the string Yes
console.log(testLogicalAnd(24)) //should return the string No
console.log(testLogicalAnd(10)) //should return the string No
